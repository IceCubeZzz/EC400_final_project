...
import torch
from controllernet import ControllerNet
import numpy as np
...
class Kart:
    ...
    def __init__(self, state_dim, action_dim, save_dir):
        ...
        self.net = ControllerNet(self.state_dim, self.action_dim).float()
...
class Kart(Kart):
    ...
    def learn(self):
        ...
        # Get TD Estimate
        # state.transpose_(2, 3).transpose_(1, 2).byte()
        td_est = self.td_estimate(state, action)

        # next_state.transpose_(2, 3).transpose_(1, 2).byte()
        # Get TD Target
