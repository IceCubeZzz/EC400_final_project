...
class Planner(torch.nn.Module):
    def __init__(self):
        ...
        layers = []
        layers.append(torch.nn.Conv2d(3, 16, 3, 1, 2))
        layers.append(torch.nn.LeakyReLU(.2))
        layers.append(torch.nn.Conv2d(16, 3, 3, 1, 1))
        layers.append(torch.nn.LeakyReLU(.2))
        layers.append(torch.nn.Linear(130, 80))
        layers.append(torch.nn.LeakyReLU(.2))
        layers.append(torch.nn.Linear(80, 60))
        layers.append(torch.nn.LeakyReLU(.2))
        layers.append(torch.nn.Linear(60, 30))
